"use client";
import { TotalPenjualanProps } from "@/lib/utilities";
import React, { useState } from "react";

export default function ViewTotalPengeluaran() {
  const [data, setData] = useState<TotalPenjualanProps[]>([]);
  ...
  const HandleFilter = async () => {
    try {
      if (typeof window !== undefined) {
        ...
        const response = await fetch(`http://localhost:8000/api/admin/view-total-penjualan`, {
          method: "POST",
          headers: {
